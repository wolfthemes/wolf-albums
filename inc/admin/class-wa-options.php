...
class WA_Options {
	...
	public function add_settings_menu() {
		...
		add_submenu_page( 'edit.php?post_type=gallery', esc_html__( 'Settings', '%TEXTDOMAIN%' ), esc_html__( 'Settings', '%TEXTDOMAIN%' ), 'edit_plugins', 'wolf-albums-settings', array( $this, 'options_form' ) );
		add_submenu_page( 'edit.php?post_type=gallery', esc_html__( 'Shortcode', '%TEXTDOMAIN%' ), esc_html__( 'Shortcode', '%TEXTDOMAIN%' ), 'edit_plugins', 'wolf-albums-shortcode', array( $this, 'help' ) );
	}
	...
	public function register_settings() {
		...
		add_settings_field( 'page_id', esc_html__( 'Albums Page', '%TEXTDOMAIN%' ), array( $this, 'setting_page_id' ), 'wolf-albums-settings', 'wolf-albums-settings' );
		// add_settings_field( 'layout', esc_html__( 'Layout', '%TEXTDOMAIN%' ), array( $this, 'setting_layout' ), 'wolf-albums-settings', 'wolf-albums-settings' );
		add_settings_field( 'columns', esc_html__( 'Max number of column', '%TEXTDOMAIN%' ), array( $this, 'setting_columns' ), 'wolf-albums-settings', 'wolf-albums-settings', array( 'class' => 'wolf-albums-settings-columns' ) );
	}
	...
	public function help() {
		?>
		<div class="wrap">
			<h2><?php esc_html_e( 'Albums Shortcode', '%TEXTDOMAIN%' ) ?></h2>
			<p><?php esc_html_e( 'To display your last albums in your post or page you can use the following shortcode.', '%TEXTDOMAIN%' ); ?></p>
